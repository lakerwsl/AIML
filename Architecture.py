...
for i in range(0,4):
  ...
  for t in range(0,5):
    ...
    results.append([sample_num,1,t,accuracy])   
...
for i in range(0,4):
  ...
  for t in range(0,5):
    ...
    knn.fit(rx_train_representation[0:sample_num_train,], ry_train[0:sample_num_train])
    accuracy = knn.score(rx_train_representation[sample_num_train:(sample_num_train*2),], ry_train[sample_num_train:(sample_num_train*2)])
    results.append([sample_num,2,t,accuracy])   
...
for i in range(0,4):
  ...
  for t in range(0,5):
    ...
    knn.fit(rx_train_representation[0:sample_num_train,], ry_train[0:sample_num_train])
    accuracy = knn.score(rx_train_representation[sample_num_train:(sample_num_train*2),], ry_train[sample_num_train:(sample_num_train*2)])
    results.append([sample_num,3,t,accuracy])   


np.savez('architecture_tuning.npz', results=results)
